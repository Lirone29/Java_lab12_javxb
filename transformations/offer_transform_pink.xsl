...
<xsl:template match="/">
    <html><body style="background: #ffb3d9; color: #660033;">
       <xsl:apply-templates/>
    </body></html>
 </xsl:template>
...
<xsl:template match="/offer/offer_name">
   <h1 align="center"> <xsl:apply-templates/> </h1>
    ...
    <xsl:template match="/offer/offer_description">
        <h2 align="center" bgcolor="#ffe6f2">Offer:</h2>
    ...
    <xsl:template match="/offer/travelAgency">
        ...
        <p align="center" bgcolor="#ffe6f2"><xsl:value-of select="travelAgency_name"/>&#160;<br/>
